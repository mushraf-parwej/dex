...
interface SwapFormData {
  sellAmount: string;
  buyAmount: string;
  coin1: { image: string; name: string; symbol: string; address: string };
  coin2: { image: string; name: string; symbol: string; address: string };
}
          ...
          {isSubmitted ? (
            ...
            >
              <SwapConfirmation
                ...
                onConfirm={async () => {
                  try {
                    // Execute the swap transaction via the SwapRouter
